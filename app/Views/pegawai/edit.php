...
<div class="container">
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <hr>
            <form action="<?php echo base_url('pegawai/update/' . $pegawai['nip']); ?>" method="post">

                <div class="form-group">
                    <label for="">NIP Pegawai</label>
                    <input type="text" name="nip" class="form-control" placeholder="NIP Pegawai" value="<?php echo $pegawai['nip']; ?>">
                </div>
                <div class="form-group">
                    <label for="">Nama Pegawai</label>
                    <input name="nama" class="form-control" placeholder="Nama Pegawai" value="<?php echo $pegawai['nama']; ?>"></input>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input name="Tempatlahir" class="form-control" placeholder="Tempat Lahir" value="<?php echo $pegawai['Tempatlahir']; ?>"></input>
                </div>
                <div class="form-group">
                    <label for="">Tanggal Lahir</label>
                    <input name="Tanggallahir" class="form-control" placeholder="YYYY-MM-DD" value="<?php echo $pegawai['Tanggallahir']; ?>"></input>
                </div>
                <div class="form-group">
                    <label for="">Agama</label>
                    <input name="agama" class="form-control" placeholder="Agama" value="<?php echo $pegawai['agama']; ?>"></input>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat" class="form-control" placeholder="Alamat" value="<?php echo $pegawai['alamat']; ?>"></textarea>
                </div>
                ...
                <div class="form-group row">
                    <label for="kodegolongan" class="col-sm-3">Jabatan</label>
                    <select id="kodegolongan" name="kodegolongan" class="custom-select border-transparent" data-style="btn btn-link">
                        <option id="kodegolongan" name="kodegolongan" selected>Pilih Jabatan..
                            <?php
                            $con = new mysqli("localhost", "root", "", "10119269_kepegawaian");
