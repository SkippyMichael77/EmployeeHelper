...
<div class="container">
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <hr>
            <form action="<?php echo base_url('lembur/update/' . $lembur['id']); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input name="tgl_lembur" class="form-control" placeholder="YYYY-MM-DD" value="<?php echo $lembur['tgl_lembur']; ?>"></input>
                </div>
                <div class="form-group">
                    <label for="">Lembur</label>
                    <input name="lembur" class="form-control" placeholder="Jumlah Lembur" value="<?php echo $lembur['lembur']; ?>"></input>
                </div>
                <div class="form-group">
