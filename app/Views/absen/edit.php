...
<div class="container">
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <hr>
            <form action="<?php echo base_url('absen/update/' . $absen['id']); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input name="masuk" class="form-control" placeholder="Jumlah Masuk" value="<?php echo $absen['masuk']; ?>"></input>
                </div>
                <div class="form-group">
                    <label for="">Izin</label>
                    <input name="izin" class="form-control" placeholder="Jumlah Izin" value="<?php echo $absen['izin']; ?>"></input>
                </div>
                <div class="form-group">
                    <label for="">Alpha</label>
                    <input name="alpha" class="form-control" placeholder="Jumlah Alpha" value="<?php echo $absen['alpha']; ?>"></input>
                </div>
                <div class="form-group">
